...
async function generateRegistry(options) {
  ...
  try {
    ...
    const content2 = `// AUTO-GENERATED BY @stonethrow/vite-plugin-auto-registry
...
`;
  ...
  const content = `// AUTO-GENERATED BY @stonethrow/vite-plugin-auto-registry
...
function stoneAutoRegistry(options) {
  return {
    name: "@stonethrow/vite-plugin-auto-registry",
    enforce: "pre",
